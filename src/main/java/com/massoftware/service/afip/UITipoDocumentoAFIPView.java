...
@Route("TipoDocumentoAFIP")
public class UITipoDocumentoAFIPView extends VerticalLayout implements HasUrlParameter<String> {

	private TipoDocumentoAFIPService service;		

	// Binder
	private TipoDocumentoAFIP item;
	private Binder<TipoDocumentoAFIP> binder;
	...
	public UITipoDocumentoAFIPView() throws Exception {
		service = new TipoDocumentoAFIPService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new TipoDocumentoAFIP();
		binder = new Binder<>(TipoDocumentoAFIP.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(TipoDocumentoAFIP::getNumero, TipoDocumentoAFIP::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(TipoDocumentoAFIP::getNombre, TipoDocumentoAFIP::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<TipoDocumentoAFIP> validate = binder.validate();
