...
public class MonedasAFIPStm extends StatementParam {

	public MonedasAFIPStm(MonedasAFIPFiltro f, boolean count) {
		super();

		if (f == null) {
			throw new IllegalArgumentException("QUERY: Se esperaba un bojeto para filtrar la consulta. Se esperaba "
					+ MonedasAFIPFiltro.class.getCanonicalName());
		}
		...
		String sql = "SELECT  " + atts + " FROM massoftware.MonedaAFIP " + join + buildWhere(f) + orderBy + page;

		this.setSql(sql);

	}

	private String buildWhere(MonedasAFIPFiltro f) {
