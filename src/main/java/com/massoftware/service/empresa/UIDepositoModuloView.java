...
@PageTitle("Módulo")
@Route("DepositoModulo")
public class UIDepositoModuloView extends VerticalLayout implements HasUrlParameter<String> {

	private DepositoModuloService service;		

	// Binder
	private DepositoModulo item;
	private Binder<DepositoModulo> binder;
	...
	public UIDepositoModuloView() throws Exception {
		service = new DepositoModuloService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new DepositoModulo();
		binder = new Binder<>(DepositoModulo.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(DepositoModulo::getNumero, DepositoModulo::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(DepositoModulo::getNombre, DepositoModulo::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<DepositoModulo> validate = binder.validate();
