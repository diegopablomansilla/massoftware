...
public class UISucursalesGrid extends GridCustom<Sucursales> {

	private SucursalesFiltro filter;
	private SucursalService service;

	public UISucursalesGrid(SucursalService service, SucursalesFiltro filter) {
		super(Sucursales.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(Sucursales::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(Sucursales::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Sucursal")
			.setVisible(false);
		...
		addColumn(Sucursales::getNombreTipoSucursal, "nombreTipoSucursal")
			.setKey("nombreTipoSucursal")
			.setResizable(true)
			.setSortProperty("2")
			.setHeader("Tipo sucursal");

		addColumn(Sucursales::getNumero, "numero")
			.setKey("numero")
			.setResizable(true)
			.setSortProperty("3")
			.setHeader("Nº sucursal");

		addColumn(Sucursales::getNombre, "nombre")
			.setKey("nombre")
			.setResizable(true)
			.setSortProperty("4")
			.setHeader("Nombre");
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<Sucursales> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<Sucursales> items = service.find(filter);
	...
	protected boolean removeItemFromService(Sucursales item) {
