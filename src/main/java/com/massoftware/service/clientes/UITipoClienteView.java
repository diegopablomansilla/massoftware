...
@PageTitle("Tipo de cliente")
@Route("TipoCliente")
public class UITipoClienteView extends VerticalLayout implements HasUrlParameter<String> {

	private TipoClienteService service;		

	// Binder
	private TipoCliente item;
	private Binder<TipoCliente> binder;
	...
	public UITipoClienteView() throws Exception {
		service = new TipoClienteService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		...
		binder = new Binder<>(TipoCliente.class);
		binder.setBean(item);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(TipoCliente::getNombre, TipoCliente::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<TipoCliente> validate = binder.validate();
