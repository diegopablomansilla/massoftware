...
public class UIClasificacionesClientesGrid extends GridCustom<ClasificacionesClientes> {

	private ClasificacionesClientesFiltro filter;
	private ClasificacionClienteService service;

	public UIClasificacionesClientesGrid(ClasificacionClienteService service, ClasificacionesClientesFiltro filter) {
		super(ClasificacionesClientes.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(ClasificacionesClientes::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(ClasificacionesClientes::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<ClasificacionesClientes> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<ClasificacionesClientes> items = service.find(filter);
		...
		return new ArrayList<ClasificacionesClientes>();
	}

	protected boolean removeItemFromService(ClasificacionesClientes item) {
