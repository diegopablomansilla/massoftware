...
public class UIMotivosComentarioGrid extends GridCustom<MotivosComentario> {

	private MotivosComentarioFiltro filter;
	private MotivoComentarioService service;

	public UIMotivosComentarioGrid(MotivoComentarioService service, MotivosComentarioFiltro filter) {
		super(MotivosComentario.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(MotivosComentario::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(MotivosComentario::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Motivo de comentario")
			.setVisible(false);
		...
		addColumn(MotivosComentario::getNumero, "numero")
			.setKey("numero")
			.setResizable(true)
			.setSortProperty("2")
			.setHeader("Nº motivo");

		addColumn(MotivosComentario::getNombre, "nombre")
			.setKey("nombre")
			.setResizable(true)
			.setSortProperty("3")
			.setHeader("Nombre");
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<MotivosComentario> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<MotivosComentario> items = service.find(filter);
		...
		return new ArrayList<MotivosComentario>();
	}

	protected boolean removeItemFromService(MotivosComentario item) {
