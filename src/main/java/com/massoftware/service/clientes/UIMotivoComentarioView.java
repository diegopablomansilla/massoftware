...
@PageTitle("Motivo de comentario")
@Route("MotivoComentario")
public class UIMotivoComentarioView extends VerticalLayout implements HasUrlParameter<String> {

	private MotivoComentarioService service;		

	// Binder
	private MotivoComentario item;
	private Binder<MotivoComentario> binder;
	...
	public UIMotivoComentarioView() throws Exception {
		service = new MotivoComentarioService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new MotivoComentario();
		binder = new Binder<>(MotivoComentario.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(MotivoComentario::getNumero, MotivoComentario::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(MotivoComentario::getNombre, MotivoComentario::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<MotivoComentario> validate = binder.validate();
