...
@PageTitle("Carga")
@Route("Carga")
public class UICargaView extends VerticalLayout implements HasUrlParameter<String> {

	private CargaService service;		

	// Binder
	private Carga item;
	private Binder<Carga> binder;
	...
	private ComboBox<Transporte> transporte;
	...
	public UICargaView() throws Exception {
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(Carga::getNombre, Carga::setNombre);
	}

	private void buildTransporte() throws Exception {
		// Transporte
		transporte = new ComboBox<>();
		transporte.setLabel("Transporte");
		transporte.setWidthFull();
		transporte.setRequired(true);
		List<Transporte> items = new TransporteService().find();
		transporte.setItems(items);
		binder.forField(transporte)
			.asRequired("Transporte es requerido.")		
			.bind(Carga::getTransporte, Carga::setTransporte);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<Carga> validate = binder.validate();
