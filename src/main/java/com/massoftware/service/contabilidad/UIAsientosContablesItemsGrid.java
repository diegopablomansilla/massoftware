...
public class UIAsientosContablesItemsGrid extends GridCustom<AsientosContablesItems> {

	private AsientosContablesItemsFiltro filter;
	private AsientoContableItemService service;

	public UIAsientosContablesItemsGrid(AsientoContableItemService service, AsientosContablesItemsFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(AsientosContablesItems::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(AsientosContablesItems::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Item de asiento contable")
			.setVisible(false);
	...
	*/
	...
	protected List<AsientosContablesItems> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<AsientosContablesItems> items = service.find(filter);
	...
	protected boolean removeItemFromService(AsientosContablesItems item) {
