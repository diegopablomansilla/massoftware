...
@PageTitle("Tipo punto equilibrio")
@Route("TipoPuntoEquilibrio")
public class UITipoPuntoEquilibrioView extends VerticalLayout implements HasUrlParameter<String> {

	private TipoPuntoEquilibrioService service;		

	// Binder
	private TipoPuntoEquilibrio item;
	private Binder<TipoPuntoEquilibrio> binder;
	...
	public UITipoPuntoEquilibrioView() throws Exception {
		service = new TipoPuntoEquilibrioService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new TipoPuntoEquilibrio();
		binder = new Binder<>(TipoPuntoEquilibrio.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(TipoPuntoEquilibrio::getNumero, TipoPuntoEquilibrio::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(TipoPuntoEquilibrio::getNombre, TipoPuntoEquilibrio::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<TipoPuntoEquilibrio> validate = binder.validate();
