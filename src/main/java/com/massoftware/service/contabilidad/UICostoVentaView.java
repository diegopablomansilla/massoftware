...
@PageTitle("Costo de venta")
@Route("CostoVenta")
public class UICostoVentaView extends VerticalLayout implements HasUrlParameter<String> {

	private CostoVentaService service;		

	// Binder
	private CostoVenta item;
	private Binder<CostoVenta> binder;
	...
	public UICostoVentaView() throws Exception {
		service = new CostoVentaService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new CostoVenta();
		binder = new Binder<>(CostoVenta.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(CostoVenta::getNumero, CostoVenta::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(CostoVenta::getNombre, CostoVenta::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<CostoVenta> validate = binder.validate();
