...
@PageTitle("Minuta contable")
@Route("MinutaContable")
public class UIMinutaContableView extends VerticalLayout implements HasUrlParameter<String> {

	private MinutaContableService service;		

	// Binder
	private MinutaContable item;
	private Binder<MinutaContable> binder;
	...
	public UIMinutaContableView() throws Exception {
		service = new MinutaContableService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new MinutaContable();
		binder = new Binder<>(MinutaContable.class);
		binder.setBean(item);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(MinutaContable::getNombre, MinutaContable::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<MinutaContable> validate = binder.validate();
