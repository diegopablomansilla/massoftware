...
@PageTitle("Estado")
@Route("CuentaContableEstado")
public class UICuentaContableEstadoView extends VerticalLayout implements HasUrlParameter<String> {

	private CuentaContableEstadoService service;		

	// Binder
	private CuentaContableEstado item;
	private Binder<CuentaContableEstado> binder;
	...
	public UICuentaContableEstadoView() throws Exception {
		service = new CuentaContableEstadoService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new CuentaContableEstado();
		binder = new Binder<>(CuentaContableEstado.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(CuentaContableEstado::getNumero, CuentaContableEstado::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(CuentaContableEstado::getNombre, CuentaContableEstado::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<CuentaContableEstado> validate = binder.validate();
