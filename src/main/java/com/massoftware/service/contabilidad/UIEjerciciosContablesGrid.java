...
public class UIEjerciciosContablesGrid extends GridCustom<EjerciciosContables> {

	private EjerciciosContablesFiltro filter;
	private EjercicioContableService service;

	public UIEjerciciosContablesGrid(EjercicioContableService service, EjerciciosContablesFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(EjerciciosContables::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(EjerciciosContables::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Ejercicio")
			.setVisible(false);
	...
	*/
	...
	protected List<EjerciciosContables> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<EjerciciosContables> items = service.find(filter);
		...
		return new ArrayList<EjerciciosContables>();
	}

	protected boolean removeItemFromService(EjerciciosContables item) {
