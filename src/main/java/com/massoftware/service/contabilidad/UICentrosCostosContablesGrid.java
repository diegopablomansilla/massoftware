...
public class UICentrosCostosContablesGrid extends GridCustom<CentrosCostosContables> {

	private CentrosCostosContablesFiltro filter;
	private CentroCostoContableService service;

	public UICentrosCostosContablesGrid(CentroCostoContableService service, CentrosCostosContablesFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(CentrosCostosContables::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(CentrosCostosContables::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Centro de costo")
			.setVisible(false);
	...
	*/
	...
	protected List<CentrosCostosContables> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<CentrosCostosContables> items = service.find(filter);
	...
	protected boolean removeItemFromService(CentrosCostosContables item) {
