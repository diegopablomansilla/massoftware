...
public class UICuentasContablesGrid extends GridCustom<CuentasContables> {

	private CuentasContablesFiltro filter;
	private CuentaContableService service;

	public UICuentasContablesGrid(CuentaContableService service, CuentasContablesFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(CuentasContables::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(CuentasContables::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
	...
	*/
	...
	protected List<CuentasContables> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<CuentasContables> items = service.find(filter);
	...
	protected boolean removeItemFromService(CuentasContables item) {
