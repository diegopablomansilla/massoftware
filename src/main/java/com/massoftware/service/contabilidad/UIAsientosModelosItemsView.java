...
public class UIAsientosModelosItemsView extends VerticalLayout {
...
// botonera no ordenable no movible
	...
	// Binder
	private AsientosModelosItemsFiltro lastFilter;
	private AsientosModelosItemsFiltro filter;
	private Binder<AsientosModelosItemsFiltro> binder;
	...
	// Grid
	private UIAsientosModelosItemsGrid grid;

	public UIAsientosModelosItemsView() throws Exception {
		buildBinder();
		buildFilterRows();
		buildGrid();
		this.setHeightFull();		
	...
	private void buildBinder() {
		filter = new AsientosModelosItemsFiltro();
		binder = new Binder<>(AsientosModelosItemsFiltro.class);
