...
//		this.search();
	...
	private void buildForm() throws Exception {
		...
		tipoPuntoEquilibrio.setPlaceholder("Tipo");
...
//		form.add(newBTN, numeroFrom, numeroTo, nombre, findBTN);
		form.add(numero, nombre, tipoPuntoEquilibrio, ejercicioContable);
	...
	public void search(String id) {
		...
		try {
			...
			PuntoEquilibrioService service = new PuntoEquilibrioService();
