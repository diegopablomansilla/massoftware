...
public class UICostosVentasGrid extends GridCustom<CostosVentas> {

	private CostosVentasFiltro filter;
	private CostoVentaService service;

	public UICostosVentasGrid(CostoVentaService service, CostosVentasFiltro filter) {
		super(CostosVentas.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(CostosVentas::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(CostosVentas::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Costo de venta")
			.setVisible(false);
		...
		addColumn(CostosVentas::getNumero, "numero")
			.setKey("numero")
			.setResizable(true)
			.setSortProperty("2")
			.setHeader("Nº tipo");

		addColumn(CostosVentas::getNombre, "nombre")
			.setKey("nombre")
			.setResizable(true)
			.setSortProperty("3")
			.setHeader("Nombre");
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<CostosVentas> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<CostosVentas> items = service.find(filter);
		...
		return new ArrayList<CostosVentas>();
	}

	protected boolean removeItemFromService(CostosVentas item) {
