...
public class UIAsientosContablesGrid extends GridCustom<AsientosContables> {

	private AsientosContablesFiltro filter;
	private AsientoContableService service;

	public UIAsientosContablesGrid(AsientoContableService service, AsientosContablesFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(AsientosContables::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(AsientosContables::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Asiento contable")
			.setVisible(false);
	...
	*/
	...
	protected List<AsientosContables> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<AsientosContables> items = service.find(filter);
	...
	protected boolean removeItemFromService(AsientosContables item) {
