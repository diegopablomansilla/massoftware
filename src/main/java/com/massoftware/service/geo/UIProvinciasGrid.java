...
public class UIProvinciasGrid extends GridCustom<Provincias> {

	private ProvinciasFiltro filter;
	private ProvinciaService service;

	public UIProvinciasGrid(ProvinciaService service, ProvinciasFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(Provincias::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(Provincias::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Provincia")
			.setVisible(false);
		...
		addColumn(Provincias::getNombrePais, "nombrePais")
			.setKey("nombrePais")
			.setResizable(true)
			.setSortProperty("2")
			.setHeader("Pais");

		addColumn(Provincias::getNumero, "numero")
			.setKey("numero")
			.setResizable(true)
			.setSortProperty("3")
			.setHeader("Nº provincia");

		addColumn(Provincias::getAbreviatura, "abreviatura")
			.setKey("abreviatura")
			.setResizable(true)
			.setSortProperty("4")
			.setHeader("Abreviatura");

		addColumn(Provincias::getNombre, "nombre")
			.setKey("nombre")
			.setResizable(true)
			.setSortProperty("5")
			.setHeader("Nombre");
	...
	*/
	...
	protected List<Provincias> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<Provincias> items = service.find(filter);
	...
	protected boolean removeItemFromService(Provincias item) {
