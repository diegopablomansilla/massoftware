...
public class UIZonasGrid extends GridCustom<Zonas> {

	private ZonasFiltro filter;
	private ZonaService service;

	public UIZonasGrid(ZonaService service, ZonasFiltro filter) {
		super(Zonas.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(Zonas::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(Zonas::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Zona")
			.setVisible(false);
		...
		addColumn(Zonas::getCodigo, "codigo")
			.setKey("codigo")
			.setResizable(true)
			.setSortProperty("2")
			.setHeader("Código");

		addColumn(Zonas::getNombre, "nombre")
			.setKey("nombre")
			.setResizable(true)
			.setSortProperty("3")
			.setHeader("Nombre");

		addColumn(Zonas::getBonificacion, "bonificacion")
			.setKey("bonificacion")
			.setResizable(true)
			.setSortProperty("4")
			.setHeader("Bonificación");

		addColumn(Zonas::getRecargo, "recargo")
			.setKey("recargo")
			.setResizable(true)
			.setSortProperty("5")
			.setHeader("Recargo");
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<Zonas> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<Zonas> items = service.find(filter);
	...
	protected boolean removeItemFromService(Zonas item) {
