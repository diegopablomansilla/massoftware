...
public class UICuentasFondosBancosCopiasGrid extends GridCustom<CuentasFondosBancosCopias> {

	private CuentasFondosBancosCopiasFiltro filter;
	private CuentaFondoBancoCopiaService service;

	public UICuentasFondosBancosCopiasGrid(CuentaFondoBancoCopiaService service, CuentasFondosBancosCopiasFiltro filter) {
		super(CuentasFondosBancosCopias.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(CuentasFondosBancosCopias::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(CuentasFondosBancosCopias::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<CuentasFondosBancosCopias> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<CuentasFondosBancosCopias> items = service.find(filter);
		...
		return new ArrayList<CuentasFondosBancosCopias>();
	}

	protected boolean removeItemFromService(CuentasFondosBancosCopias item) {
