...
public class UIJuridiccionesConvniosMultilateralesGrid extends GridCustom<JuridiccionesConvniosMultilaterales> {

	private JuridiccionesConvniosMultilateralesFiltro filter;
	private JuridiccionConvnioMultilateralService service;

	public UIJuridiccionesConvniosMultilateralesGrid(JuridiccionConvnioMultilateralService service, JuridiccionesConvniosMultilateralesFiltro filter) {
		super(JuridiccionesConvniosMultilaterales.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(JuridiccionesConvniosMultilaterales::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(JuridiccionesConvniosMultilaterales::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Juridicción de convnio multilateral")
			.setVisible(false);
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<JuridiccionesConvniosMultilaterales> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<JuridiccionesConvniosMultilaterales> items = service.find(filter);
		...
		return new ArrayList<JuridiccionesConvniosMultilaterales>();
	}

	protected boolean removeItemFromService(JuridiccionesConvniosMultilaterales item) {
