...
@PageTitle("Rubro de cuenta fondo")
@Route("CuentaFondoRubro")
public class UICuentaFondoRubroView extends VerticalLayout implements HasUrlParameter<String> {

	private CuentaFondoRubroService service;		

	// Binder
	private CuentaFondoRubro item;
	private Binder<CuentaFondoRubro> binder;
	...
	public UICuentaFondoRubroView() throws Exception {
		service = new CuentaFondoRubroService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new CuentaFondoRubro();
		binder = new Binder<>(CuentaFondoRubro.class);
		binder.setBean(item);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(CuentaFondoRubro::getNombre, CuentaFondoRubro::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<CuentaFondoRubro> validate = binder.validate();
