...
public class UICuentasFondosGruposGrid extends GridCustom<CuentasFondosGrupos> {

	private CuentasFondosGruposFiltro filter;
	private CuentaFondoGrupoService service;

	public UICuentasFondosGruposGrid(CuentaFondoGrupoService service, CuentasFondosGruposFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(CuentasFondosGrupos::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(CuentasFondosGrupos::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Grupo de cuenta fondo")
			.setVisible(false);
	...
	*/
	...
	protected List<CuentasFondosGrupos> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<CuentasFondosGrupos> items = service.find(filter);
	...
	protected boolean removeItemFromService(CuentasFondosGrupos item) {
