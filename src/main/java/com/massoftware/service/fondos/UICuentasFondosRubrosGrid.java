...
public class UICuentasFondosRubrosGrid extends GridCustom<CuentasFondosRubros> {

	private CuentasFondosRubrosFiltro filter;
	private CuentaFondoRubroService service;

	public UICuentasFondosRubrosGrid(CuentaFondoRubroService service, CuentasFondosRubrosFiltro filter) {
		super(CuentasFondosRubros.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(CuentasFondosRubros::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(CuentasFondosRubros::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Rubro de cuenta fondo")
			.setVisible(false);
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<CuentasFondosRubros> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<CuentasFondosRubros> items = service.find(filter);
		...
		return new ArrayList<CuentasFondosRubros>();
	}

	protected boolean removeItemFromService(CuentasFondosRubros item) {
