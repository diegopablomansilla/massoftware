...
public class UITalonariosLetrasView extends VerticalLayout {
...
// botonera no ordenable no movible
	...
	// Binder
	private TalonariosLetrasFiltro lastFilter;
	private TalonariosLetrasFiltro filter;
	private Binder<TalonariosLetrasFiltro> binder;
	...
	// Grid
	private UITalonariosLetrasGrid grid;

	public UITalonariosLetrasView() throws Exception {
		buildBinder();
		buildFilterRows();
		buildGrid();
		this.setHeightFull();		
	...
	private void buildBinder() {
		filter = new TalonariosLetrasFiltro();
		binder = new Binder<>(TalonariosLetrasFiltro.class);
