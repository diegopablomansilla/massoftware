...
@PageTitle("Tipo de cuenta fondo")
@Route("CuentaFondoTipo")
public class UICuentaFondoTipoView extends VerticalLayout implements HasUrlParameter<String> {

	private CuentaFondoTipoService service;		

	// Binder
	private CuentaFondoTipo item;
	private Binder<CuentaFondoTipo> binder;
	...
	public UICuentaFondoTipoView() throws Exception {
		service = new CuentaFondoTipoService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new CuentaFondoTipo();
		binder = new Binder<>(CuentaFondoTipo.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(CuentaFondoTipo::getNumero, CuentaFondoTipo::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(CuentaFondoTipo::getNombre, CuentaFondoTipo::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<CuentaFondoTipo> validate = binder.validate();
