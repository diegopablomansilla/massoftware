...
@Route("ComprobanteFondoModelo")
public class UIComprobanteFondoModeloView extends VerticalLayout implements HasUrlParameter<String> {

	private ComprobanteFondoModeloService service;		

	// Binder
	private ComprobanteFondoModelo item;
	private Binder<ComprobanteFondoModelo> binder;
	...
	public UIComprobanteFondoModeloView() throws Exception {
		service = new ComprobanteFondoModeloService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new ComprobanteFondoModelo();
		binder = new Binder<>(ComprobanteFondoModelo.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(ComprobanteFondoModelo::getNumero, ComprobanteFondoModelo::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(ComprobanteFondoModelo::getNombre, ComprobanteFondoModelo::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<ComprobanteFondoModelo> validate = binder.validate();
