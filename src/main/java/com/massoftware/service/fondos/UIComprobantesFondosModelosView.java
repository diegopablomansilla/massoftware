...
public class UIComprobantesFondosModelosView extends VerticalLayout {
...
// botonera no ordenable no movible
	...
	// Binder
	private ComprobantesFondosModelosFiltro lastFilter;
	private ComprobantesFondosModelosFiltro filter;
	private Binder<ComprobantesFondosModelosFiltro> binder;
	...
	// Grid
	private UIComprobantesFondosModelosGrid grid;

	public UIComprobantesFondosModelosView() throws Exception {
		buildBinder();
		buildFilterRows();
		buildGrid();
		this.setHeightFull();		
	...
	private void buildBinder() {
		filter = new ComprobantesFondosModelosFiltro();
		binder = new Binder<>(ComprobantesFondosModelosFiltro.class);
	...
	private void buildFilterRows() throws Exception {
		...
		binder.forField(numeroFrom)
			...
			.bind(ComprobantesFondosModelosFiltro::getNumeroFrom, ComprobantesFondosModelosFiltro::setNumeroFrom);
		...
		binder.forField(numeroTo)
			...
			.withValidator(value -> (value != null) ? value >= 1 : true, "El valor tiene que ser >= 1")
			.withValidator(value -> (value != null) ? value <= Integer.MAX_VALUE : true,"El valor tiene que ser <= " + Integer.MAX_VALUE)
			.bind(ComprobantesFondosModelosFiltro::getNumeroTo, ComprobantesFondosModelosFiltro::setNumeroTo);
