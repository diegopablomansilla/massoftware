...
public class UIComprobantesFondosModelosGrid extends GridCustom<ComprobantesFondosModelos> {

	private ComprobantesFondosModelosFiltro filter;
	private ComprobanteFondoModeloService service;

	public UIComprobantesFondosModelosGrid(ComprobanteFondoModeloService service, ComprobantesFondosModelosFiltro filter) {
		super(ComprobantesFondosModelos.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(ComprobantesFondosModelos::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(ComprobantesFondosModelos::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Modelo de comprobante de fondo")
			.setVisible(false);
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<ComprobantesFondosModelos> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<ComprobantesFondosModelos> items = service.find(filter);
		...
		return new ArrayList<ComprobantesFondosModelos>();
	}

	protected boolean removeItemFromService(ComprobantesFondosModelos item) {
