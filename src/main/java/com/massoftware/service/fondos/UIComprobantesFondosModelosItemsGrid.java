...
public class UIComprobantesFondosModelosItemsGrid extends GridCustom<ComprobantesFondosModelosItems> {

	private ComprobantesFondosModelosItemsFiltro filter;
	private ComprobanteFondoModeloItemService service;

	public UIComprobantesFondosModelosItemsGrid(ComprobanteFondoModeloItemService service, ComprobantesFondosModelosItemsFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(ComprobantesFondosModelosItems::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(ComprobantesFondosModelosItems::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
	...
	*/
	...
	protected List<ComprobantesFondosModelosItems> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<ComprobantesFondosModelosItems> items = service.find(filter);
	...
	protected boolean removeItemFromService(ComprobantesFondosModelosItems item) {
