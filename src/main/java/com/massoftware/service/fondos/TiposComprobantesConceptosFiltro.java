...
public class TiposComprobantesConceptosFiltro extends GenericFilter implements Cloneable {
	...
	public TiposComprobantesConceptosFiltro clone() {
		
		TiposComprobantesConceptosFiltro other = new TiposComprobantesConceptosFiltro();
