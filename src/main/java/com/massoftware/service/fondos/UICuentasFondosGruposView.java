...
public class UICuentasFondosGruposView extends VerticalLayout {
...
// botonera no ordenable no movible
	...
	// Binder
	private CuentasFondosGruposFiltro lastFilter;
	private CuentasFondosGruposFiltro filter;
	private Binder<CuentasFondosGruposFiltro> binder;
	...
	// Grid
	private UICuentasFondosGruposGrid grid;

	public UICuentasFondosGruposView() throws Exception {
		buildBinder();
		buildFilterRows();
		buildGrid();
		this.setHeightFull();
	...
	private void buildBinder() {
		filter = new CuentasFondosGruposFiltro();
		binder = new Binder<>(CuentasFondosGruposFiltro.class);
	...
	private void buildFilterRows() {
		...
		binder.forField(numeroFrom)
			...
			.bind(CuentasFondosGruposFiltro::getNumeroFrom, CuentasFondosGruposFiltro::setNumeroFrom);
		...
		numeroTo.setPlaceholder("Nº grupo hasta ");
		...
		binder.forField(numeroTo)
			...
			.withValidator(value -> (value != null) ? value >= 1 : true, "El valor tiene que ser >= 1")
			.withValidator(value -> (value != null) ? value <= Integer.MAX_VALUE : true,"El valor tiene que ser <= " + Integer.MAX_VALUE)
			.bind(CuentasFondosGruposFiltro::getNumeroTo, CuentasFondosGruposFiltro::setNumeroTo);
