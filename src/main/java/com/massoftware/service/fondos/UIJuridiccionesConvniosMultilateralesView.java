...
// botonera no ordenable no movible
	...
	private void buildFilterRows() throws Exception {
		...
		numeroFrom.setPlaceholder("Nº juridicción desde ");
		...
		binder.forField(nombre)
			.bind(JuridiccionesConvniosMultilateralesFiltro::getNombre, JuridiccionesConvniosMultilateralesFiltro::setNombre);
...
//		grid = new UIJuridiccionesConvniosMultilateralesGrid(AppCX.services().buildJuridiccionConvnioMultilateralService(), filter);
		grid = new UIJuridiccionesConvniosMultilateralesGrid(new JuridiccionConvnioMultilateralService(), filter);
