...
@Route("CuentaFondoBancoCopia")
public class UICuentaFondoBancoCopiaView extends VerticalLayout implements HasUrlParameter<String> {

	private CuentaFondoBancoCopiaService service;		

	// Binder
	private CuentaFondoBancoCopia item;
	private Binder<CuentaFondoBancoCopia> binder;
	...
	public UICuentaFondoBancoCopiaView() throws Exception {
		service = new CuentaFondoBancoCopiaService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new CuentaFondoBancoCopia();
		binder = new Binder<>(CuentaFondoBancoCopia.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(CuentaFondoBancoCopia::getNumero, CuentaFondoBancoCopia::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(CuentaFondoBancoCopia::getNombre, CuentaFondoBancoCopia::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<CuentaFondoBancoCopia> validate = binder.validate();
