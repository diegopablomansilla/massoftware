...
@PageTitle("Bancos")
@Route("xbancos")
public class XUIBancosView extends VerticalLayout {
...
// botonera no ordenable no movible
	...
	// Grid
	private XUIBancosGrid grid;

	public XUIBancosView() throws Exception {
		buildBinder();
		buildFilterRows();
		buildGrid();
		this.setHeightFull();
	...
	private void buildGrid() throws Exception {
		grid = new XUIBancosGrid(AppCX.services().buildBancoService(), filter);
