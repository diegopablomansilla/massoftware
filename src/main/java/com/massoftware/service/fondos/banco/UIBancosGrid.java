...
public class UIBancosGrid extends GridCustom<Bancos> {

	private BancosFiltro filter;
	private BancoService service;

	public UIBancosGrid(BancoService service, BancosFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(Bancos::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(Bancos::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Banco")
			.setVisible(false);
		...
		addColumn(Bancos::getNombre, "nombre")
			.setKey("nombre")
			.setResizable(true)
			.setSortProperty("3")
			.setHeader("Nombre");

		addColumn(Bancos::getCuit, "cuit")
			.setKey("cuit")
			.setResizable(true)
			.setSortProperty("4")
			.setHeader("CUIT");
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	private Component createRendererVigente(Bancos item) {
		return (item.getVigente() == true) ? UIUtils.createPrimaryIcon(VaadinIcon.CHECK) : UIUtils.createDisabledIcon(VaadinIcon.CLOSE);
	}
