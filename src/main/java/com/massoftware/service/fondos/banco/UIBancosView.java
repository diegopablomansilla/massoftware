...
@PageTitle("Bancos")
@Route("Bancos")
public class UIBancosView extends VerticalLayout {
...
// botonera no ordenable no movible
	...
	// Grid
	private UIBancosGrid grid;

	public UIBancosView() throws Exception {
		buildBinder();
		buildFilterRows();
		buildGrid();
		this.setHeightFull();		
	...
	private void buildFilterRows() throws Exception {
		...
		numeroFrom.setPlaceholder("Nº banco desde ");
		...
		numeroTo.setPlaceholder("Nº banco hasta ");
