...
public class UICuentasFondosTiposBancosGrid extends GridCustom<CuentasFondosTiposBancos> {

	private CuentasFondosTiposBancosFiltro filter;
	private CuentaFondoTipoBancoService service;

	public UICuentasFondosTiposBancosGrid(CuentaFondoTipoBancoService service, CuentasFondosTiposBancosFiltro filter) {
		super(CuentasFondosTiposBancos.class, true, true, true, true);
		this.filter = filter;
	...
	protected void addColumns() {
		...
		addColumn(CuentasFondosTiposBancos::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(CuentasFondosTiposBancos::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Tipo de banco")
			.setVisible(false);
...
//		addColumn(Bancos::getCuit, "cuit").setKey("cuit").setResizable(true).setSortProperty("4").setHeader("CUIT");
	...
	*/
	...
	protected List<CuentasFondosTiposBancos> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<CuentasFondosTiposBancos> items = service.find(filter);
		...
		return new ArrayList<CuentasFondosTiposBancos>();
	}

	protected boolean removeItemFromService(CuentasFondosTiposBancos item) {
