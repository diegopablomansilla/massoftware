...
public class UIComprobantesFondosModelosItemsView extends VerticalLayout {
...
// botonera no ordenable no movible
	...
	// Binder
	private ComprobantesFondosModelosItemsFiltro lastFilter;
	private ComprobantesFondosModelosItemsFiltro filter;
	private Binder<ComprobantesFondosModelosItemsFiltro> binder;
	...
	// Grid
	private UIComprobantesFondosModelosItemsGrid grid;

	public UIComprobantesFondosModelosItemsView() throws Exception {
		buildBinder();
		buildFilterRows();
		buildGrid();
		this.setHeightFull();		
	...
	private void buildBinder() {
		filter = new ComprobantesFondosModelosItemsFiltro();
		binder = new Binder<>(ComprobantesFondosModelosItemsFiltro.class);
	...
	private void buildFilterRows() throws Exception {
		...
		numeroFrom.setPlaceholder("Nº modelo desde ");
		...
		binder.forField(numeroFrom)
			...
			.bind(ComprobantesFondosModelosItemsFiltro::getNumeroFrom, ComprobantesFondosModelosItemsFiltro::setNumeroFrom);
		...
		numeroTo.setPlaceholder("Nº modelo hasta ");
		...
		binder.forField(numeroTo)
			...
			.withValidator(value -> (value != null) ? value >= 1 : true, "El valor tiene que ser >= 1")
			.withValidator(value -> (value != null) ? value <= Integer.MAX_VALUE : true,"El valor tiene que ser <= " + Integer.MAX_VALUE)
			.bind(ComprobantesFondosModelosItemsFiltro::getNumeroTo, ComprobantesFondosModelosItemsFiltro::setNumeroTo);
