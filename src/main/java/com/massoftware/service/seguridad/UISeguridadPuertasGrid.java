...
public class UISeguridadPuertasGrid extends GridCustom<SeguridadPuertas> {

	private SeguridadPuertasFiltro filter;
	private SeguridadPuertaService service;

	public UISeguridadPuertasGrid(SeguridadPuertaService service, SeguridadPuertasFiltro filter) {
	...
	protected void addColumns() {
		...
		addColumn(SeguridadPuertas::getId, "id")
			.setKey("id")
			.setSortProperty("1")
			.setHeader("ID")
			.setVisible(false);

		addColumn(SeguridadPuertas::toString, "toString")
			.setKey("toString")
			.setSortProperty("2")
			.setHeader("Puerta")
			.setVisible(false);
	...
	*/
	...
	protected List<SeguridadPuertas> findFromService(int offset, int limit, Integer orderBy, Boolean orderByDesc) {
		...
		try {
			...
			List<SeguridadPuertas> items = service.find(filter);
	...
	protected boolean removeItemFromService(SeguridadPuertas item) {
