...
@PageTitle("Módulo")
@Route("SeguridadModulo")
public class UISeguridadModuloView extends VerticalLayout implements HasUrlParameter<String> {

	private SeguridadModuloService service;		

	// Binder
	private SeguridadModulo item;
	private Binder<SeguridadModulo> binder;
	...
	public UISeguridadModuloView() throws Exception {
		service = new SeguridadModuloService();		
		buildBinder();
		buildForm();
		this.setHeightFull();
	}
	...
	private void buildBinder() {
		item = new SeguridadModulo();
		binder = new Binder<>(SeguridadModulo.class);
		binder.setBean(item);
	}
	...
	private void buildNumero() throws Exception {
		...
		binder.forField(numero)
			...
			.bind(SeguridadModulo::getNumero, SeguridadModulo::setNumero);
	}
	...
	private void buildNombre() throws Exception {
		...
		binder.forField(nombre)
			...
			.bind(SeguridadModulo::getNombre, SeguridadModulo::setNombre);
	}
	...
	public void search(String id) {
		...
		try {
			...
			if (binder.isValid()) {											
				...
				BinderValidationStatus<SeguridadModulo> validate = binder.validate();
