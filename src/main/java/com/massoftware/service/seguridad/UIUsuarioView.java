...
@PageTitle("Usuario")
@Route("Usuario")
public class UIUsuarioView extends VerticalLayout implements HasUrlParameter<String> {
...
//	private Button findBTN;	
	...
	public UIUsuarioView() throws Exception {
		buildBinder();
		buildForm();
		this.setHeightFull();
//		this.search();
